...
class HybridSearcher:
    ...
    def fuse_results(
        ...
        semantic_map: dict[str, tuple[float, dict[str, Any]]] = {str(r[0]): (r[1], r[2]) for r in semantic_results}
        keyword_map: dict[str, float] = {r[0]: r[1] for r in keyword_results}
        ...
        for i, doc_id in enumerate(all_ids):
            ...
            combined = self.config.alpha * kw_score + (1 - self.config.alpha) * sem_score
